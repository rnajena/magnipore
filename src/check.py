...
def parse() -> Namespace:
    ...
    parser.add_argument('pore',  metavar='pore', type=str, choices=["rna_r9", "dna_r9", "rna_rp4", "dna_r10_260bps", "dna_r10_400bps"], help="Pore generation used to sequence the data. Available choices: %(choices)s")
